...
@st.cache_data
def load_data():
    sponsor_df = pd.read_csv("final_DC_sponsor_detections.csv")
    audio_df = pd.read_csv("dc_peak_sponsors.csv")
    df1 = pd.read_csv("first_innings_dc.csv")
...
""")
        ...
        with col6:
            ...
            peak_counts = exploded.value_counts().drop("No DC Sponsor Detected", errors="ignore")
...
# Mark peaks on the graph
            ...
            image7 = Image.open("dc_sponsor_prediction.jpg")
